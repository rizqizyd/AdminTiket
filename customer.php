...
<html>
    <head>
        <title>Customer - TiketWisata</title>
        <meta charset="UTF-8">
      ...
      <div class="main-content">
        ...
        <div class="row report-group">
            ...
            <div class="col-md-4">
              <div class="item-unique-customer item-customer col-md-12">
                <div class="row">
                  <div class="content col-md-12">
                        <p class="description">Wanna try to create a customer manually?</p>
                        <a href="add_new_user.php" class="btn btn-view btn-active btn-primary btn-primary-tiketwisata">Add New</a>
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="row">
                  <div class="content col-md-12">
                    <div class="wrap-picture">
                        <img class="primary-user-picture-circle" src="images/admin_picture2.png" alt="">
                    </div>
                        <p class="title"><?php echo $print_data_user_profile['nama_lengkap']?></p>
                        <p class="subtitle"><?php echo $print_data_user_profile['bio']?></p>
                        <a href="user_details.php?username=<?php echo $print_data_user_profile['username']?>" class="btn btn-view btn-primary btn-primary-tiketwisata">View Profile</a>
                    </div>
                  </div>
                </div>
            </div>
